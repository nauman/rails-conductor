...
ActiveRecord::Schema[8.1].define(version: 2026_09_07_142844) do
  ...
  create_table "apps", force: :cascade do |t|
    ...
    t.string "build_host"
    t.string "build_venue"
    t.string "ci_build_workflow"
    t.datetime "ci_refused_at"
    t.text "ci_refused_detail"
    t.string "ci_refused_reason"
    ...
    t.boolean "migrates", default: true, null: false
    t.string "name", null: false
    t.text "notes"
    t.bigint "organization_id"
    t.integer "port"
    t.datetime "release_checked_at"
    t.jsonb "release_state", default: {}, null: false
    t.string "repository_url"
    t.datetime "residue_checked_at"
    t.jsonb "residue_findings", default: [], null: false
    t.boolean "seed_on_next_deploy", default: false, null: false
    t.boolean "self_describing", default: false, null: false
    ...
    t.datetime "updated_at", null: false
    t.boolean "uses_stable_names", default: false, null: false
  ...
  create_table "backups", force: :cascade do |t|
    ...
    t.string "verification_status", default: "never_tested", null: false
  ...
  create_table "credentials", force: :cascade do |t|
    ...
    t.text "api_key"
    t.text "api_secret"
    t.integer "consecutive_empty_zone_reads", default: 0, null: false
    t.datetime "created_at", null: false
    t.string "endpoint"
    t.string "name", null: false
    t.bigint "organization_id"
  ...
  create_table "cron_jobs", force: :cascade do |t|
    ...
    t.string "task"
    t.datetime "updated_at", null: false
    t.index ["app_id"], name: "index_cron_jobs_on_app_id"
  ...
  create_table "deploy_checklist_items", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["app_id", "position"], name: "index_deploy_checklist_items_on_app_id_and_position"
    t.index ["app_id"], name: "index_deploy_checklist_items_on_app_id"
  end
  ...
  create_table "deployments", force: :cascade do |t|
    ...
    t.datetime "completed_at"
    t.datetime "created_at", null: false
    t.string "deploy_method"
    t.boolean "forced", default: false, null: false
    t.integer "infra_revision"
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["app_id", "deploy_method", "status"], name: "index_deployments_on_app_id_and_deploy_method_and_status"
  ...
  create_table "oauth_access_grants", force: :cascade do |t|
    ...
    t.index ["organization_id"], name: "index_oauth_access_grants_on_organization_id"
  ...
  create_table "oauth_access_tokens", force: :cascade do |t|
    ...
    t.index ["organization_id"], name: "index_oauth_access_tokens_on_organization_id"
  ...
  create_table "servers", force: :cascade do |t|
    ...
    t.datetime "edge_checked_at"
    t.string "edge_detail"
    t.string "edge_type"
    t.string "hostname"
    t.string "ip_address"
    t.datetime "last_audit_at"
    t.string "last_audit_status"
    t.datetime "last_harden_at"
    t.text "last_harden_log"
    t.string "last_harden_status"
    ...
    t.datetime "last_swap_reclaim_at"
    t.text "last_swap_reclaim_log"
    t.string "last_swap_reclaim_status"
    t.datetime "last_update_at"
    t.text "last_update_log"
    t.string "last_update_scope"
  ...
  create_table "site_checks", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "via_cdn", default: false, null: false
  ...
  add_foreign_key "cron_jobs", "apps"
