...
| `docs/sessions/2026-09-08-the-gate-that-never-ran.md` | A migration gate whose guard made it unreachable for every app it was written for, the ordering that left a failed migration with the app already down, and four verifications that reported success without ever running |
