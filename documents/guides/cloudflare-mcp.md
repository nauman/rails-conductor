...
controls, geo lookups, analytics, per-IP connection accounting. On this fleet a
single Cloudflare address once accounted for 91 requests in a three-minute
window, and no visitor's real address appeared even once.
