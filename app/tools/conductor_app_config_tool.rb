  ...
  DEFINITION = {
    ...
    input_schema: {
      ...
      properties: {
        ...
        value:             { type: "string",  description: "set_env: variable value. For SECRETS, do NOT paste the literal here (it enters the transcript) — instead pipe it in via `bin/conductor set-env <app> <key> --secret` (stdin → TLS body), never argv. See documents/guides/mcp.md." },
